...
| ソースコード | `src/` 配下 (20ファイル) | 33箇所 | docstring のパス参照 |
| MCPサーバー | `mcp_servers/` 配下 (19ファイル) | 44箇所 | docstring のパス参照 |
| テスト | `tests/` 配下 (34ファイル) | 419箇所 | `test_ac{N}_` テスト名 |
...
| 9. その他 | 4. 陳腐化文書整理 + 5. overview.md整合性 + 1.2 許容/禁止基準の明文化 | Phase 1, 3, 5 |
