...
**方針**: 仕様書に書かない。テスト方針は Issue に記載し、テストファイル冒頭にコメントとして転記する。

## 7. 文書種別テンプレート

テンプレート本体は `docs/specs/templates/` に配置する。各テンプレートは自己完結しており、セクション定義はすべてテンプレート内に記載されている。
...
<!-- TODO: 全テンプレート完成後に一覧・概要を記載 -->

## 8. Issue テンプレート

<!-- TODO: Phase 1 で確定予定 -->
<!-- 仕様書から移行する項目（AC、テスト方針、実験データ等）の -->
<!-- Issue 上での記載形式を定義する -->
