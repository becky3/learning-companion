...
リーダーからフェーズ変化の通知を受けたら、**チーム構成の妥当性を確認**し、必要なら再編成を促す。

| フェーズ変化 | 確認ポイント | 促しの例 |
|-------------|-------------|---------|
| 議論 → 実装 | 品質担当（code-reviewer, doc-reviewer, test-runner を使う担当）はいるか？ | 「実装フェーズに入った。品質担当は必要か？」 |
...
**重要**: フェーズ変化時の通知を受けたストーリーテラーは、チーム構成の妥当性を確認し、必要なら再編成を促す。
