...
- Mermaid GitHub 互換チェック: `uv run python "$HOME/.claude/src/tools/check_mermaid_compat.py" "docs/**/*.md" "*.md" ".claude/**/*.md"`
...
```bash
uv run python "$HOME/.claude/src/tools/check_mermaid_compat.py" "docs/**/*.md" "*.md" ".claude/**/*.md"
```
