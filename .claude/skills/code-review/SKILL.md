...
コミット前のセルフコードレビューを実施する。仕様書に基づく9つのレビュー観点で問題を検出し、修正提案を行う。
...
仕様書に記載された9つのレビュー観点（詳細は `docs/specs/code-review-agent.md` 参照）に基づいて検査を実施する。
...
9. フォールバック/暗黙のデフォルト値パターン（settings フォールバック、CLI の暗黙デフォルト値）
