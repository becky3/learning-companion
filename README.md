...
| **ユーザープロファイリング** | ユーザーとの会話から興味・スキル・学習目標を自動抽出し、プロファイルとして蓄積する |
| **学習トピック提案** | ユーザープロファイルと最新の収集記事を組み合わせて、パーソナライズされた学習トピックを提案する |
...
| **RAGナレッジ** | 外部WebページをベクトルDBに取り込み、チャット応答時に関連情報を自動検索して回答品質を向上させる |
...
- [仕様書スタイルガイド](docs/specs/style-guide.md)
